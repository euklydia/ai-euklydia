...
import shape10 from "../../assets/images/green-tech/shape.png";
import ServicesV4Data from "./ServicesV4Data.json";
import SingleServiceV4 from "./SingleServiceV4.js";
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="site-heading">
                <h4 className="sub-title">Empowering Sustainability</h4>
